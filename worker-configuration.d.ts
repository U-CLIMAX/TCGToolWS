/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ed043e9763c3be464ce944f16191b02d)
// Runtime types generated with workerd@1.20260611.1 2025-09-24 nodejs_compat
interface __BaseEnv_Env {
	MARKET_KV: KVNamespace;
	DAILY_SERIES_PRICE_KV: KVNamespace;
	DB: D1Database;
	AUTH_CODE_LIMITER: RateLimit;
	AUTH_ACTION_LIMITER: RateLimit;
	API_USER_LIMITER: RateLimit;
	PUBLIC_READ_LIMITER: RateLimit;
	VITE_WEBSITE_URL: string;
	VITE_IMAGE_BASE_URL: string;
	VITE_BLUR_IMAGE_BASE_URL: string;
	VITE_IMAGE_GLOBAL_URL: string;
	VITE_BLUR_IMAGE_GLOBAL_URL: string;
	VITE_UMAMI_SHARE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_WEBSITE_URL" | "VITE_IMAGE_BASE_URL" | "VITE_BLUR_IMAGE_BASE_URL" | "VITE_IMAGE_GLOBAL_URL" | "VITE_BLUR_IMAGE_GLOBAL_URL" | "VITE_UMAMI_SHARE_URL" | "VITE_UMAMI_SCRIPT_URL" | "VITE_UMAMI_ID" | "JWT_SECRET" | "BREVO_API_KEY" | "FRONTEND_URL" | "AFDIAN_PUBLIC_KEY" | "SCRAPER_API_KEY">> {}
}
