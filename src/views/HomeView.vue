  ...
  <v-container fluid class="home-view fill-height">
    <div class="main-content-wrapper">
      ...
      <div class="copyright-section">
        <p>版权声明</p><br />
        <p>敬请尊重并遵守官方版权相关规定。您在使用我方资料时，须同时严格遵循日本官方转载协议，例如不得将资料非法用于商业用途。</p><br />
        <p>如您的行为存在侵犯官方版权的情况，U CLIMAX网站及相关人员对此不承担任何责任，亦无任何关联。</p><br />
        <p>U CLIMAX及相关人员对本声明内容拥有最终解释权。</p><br />

        <p>附加说明</p><br />

        <p>1. 若您计划大面积使用我方资料，须事先与U CLIMAX相关负责人取得联系，并获得书面同意后方可实施。</p><br />
        <p>2. 对于會明确攻击、诋毁U CLIMAX或其相关人员的组织/个人，以及其他不受UCLIMAX欢迎的组织/个人，我方有权拒绝其使用任何资料。</p><br />
        <p>3. 一旦发现违规使用资料的行为，U CLIMAX有权要求立即撤回相关内容；根据情节严重程度，我方将采取列入黑名单、追究法律责任等进一步措施。</p><br />
